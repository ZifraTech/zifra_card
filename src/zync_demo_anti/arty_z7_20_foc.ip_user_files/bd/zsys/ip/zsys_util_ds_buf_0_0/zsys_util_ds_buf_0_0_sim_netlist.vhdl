...
-- Date        : Fri Apr 13 14:55:49 2018
-- Host        : W7-64-05 running 64-bit Service Pack 1  (build 7601)
-- Command     : write_vhdl -force -mode funcsim
--               b:/SVN/cores/customers/zifra/zybo/zybo_foc/arty_z7_20_foc.srcs/sources_1/bd/zsys/ip/zsys_util_ds_buf_0_0/zsys_util_ds_buf_0_0_sim_netlist.vhdl
...
entity zsys_util_ds_buf_0_0_util_ds_buf is
  port (
  ...
  attribute C_BUF_TYPE of zsys_util_ds_buf_0_0_util_ds_buf : entity is "BUFG";
  attribute C_SIZE : integer;
  attribute C_SIZE of zsys_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of zsys_util_ds_buf_0_0_util_ds_buf : entity is "util_ds_buf";
end zsys_util_ds_buf_0_0_util_ds_buf;

architecture STRUCTURE of zsys_util_ds_buf_0_0_util_ds_buf is
...
entity zsys_util_ds_buf_0_0 is
  ...
  attribute NotValidForBitStream of zsys_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of zsys_util_ds_buf_0_0 : entity is "zsys_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of zsys_util_ds_buf_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of zsys_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2017.4";
end zsys_util_ds_buf_0_0;

architecture STRUCTURE of zsys_util_ds_buf_0_0 is
  ...
  attribute x_interface_parameter of BUFG_O : signal is "XIL_INTERFACENAME BUFG_O, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN zsys_util_ds_buf_0_0_BUFG_O";
begin
U0: entity work.zsys_util_ds_buf_0_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_I(0) => '0',
