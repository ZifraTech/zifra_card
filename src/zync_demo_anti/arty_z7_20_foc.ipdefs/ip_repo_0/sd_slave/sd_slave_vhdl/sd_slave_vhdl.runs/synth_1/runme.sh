...
HD_PWD='/home/torbjorn/development/vhdl/cifra/sd_slave/sd_slave_vhdl/sd_slave_vhdl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sd_over_the_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sd_over_the_top.tcl
