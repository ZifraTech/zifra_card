...
HD_PWD='/home/torbjorn/development/vhdl/cifra/zync_demo_anti/arty_z7_20_foc.runs/zsys_emio_sdemu_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_emio_sdemu_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_emio_sdemu_0_0.tcl
