...
HD_PWD='/home/torbjorn/development/vhdl/cifra/zync_demo_anti/arty_z7_20_foc.runs/zsys_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zsys_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zsys_processing_system7_0_1.tcl
