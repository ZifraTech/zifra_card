...
parameter [7:0]  STAT_SPEED_CLASS       = 'h1;         // Class 2
...
parameter [1:0]  CSD_CSD_STRUCTURE      = 'b00;        // Version 1.00
...
parameter [7:0]  CSD_TRAN_SPEED_50      = 'h32;        // max data transfer rate   (50mhz)


///parameter [11:0] CSD_CCC                = 'b01_1_110110101; // card command classes
parameter [11:0] CSD_CCC                = 'b00_0_100110101; // card command classes ONLY mandatory included..
...
//parameter [21:0] CSD_C_SIZE             = 'd0;         // 1020 blocks of nand   // I will change this one from 'd249' to 'd8' I use 32bit words and 130000 depht ram fore memory
...
parameter [31:0] SD_TOTAL_BLOCKS        = 256; // 256 * 512 = 128KiB
...
parameter [3:0]  SCR_SD_SPEC            = 'd0;         // SD Memory Card - Spec. Version 1.00
