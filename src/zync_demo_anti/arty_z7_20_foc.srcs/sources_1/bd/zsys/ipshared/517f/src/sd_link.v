...
assign cmd_in_cmd = cmd_in_latch[45:40]; /* synthesis noprune */;
...
//      card_ocr <= {8'b01000000, OCR_VOLTAGE_WINDOW}; // high capacity, not powered up
      card_ocr <= {8'b00000000, OCR_VOLTAGE_WINDOW}; // NOT high capacity, not powered up
      
      
      card_cid <= {CID_FIELD_MID, CID_FIELD_OID, CID_FIELD_PNM, CID_FIELD_PRV, CID_FIELD_PSN, 
               4'b0, CID_FIELD_MDT, 8'hFF};
      card_csd <= {
            CSD_CSD_STRUCTURE, 6'h0, 
            CSD_TAAC, CSD_NSAC, 
            CSD_TRAN_SPEED_25, 
            CSD_CCC, 
            CSD_READ_BL_LEN,
               CSD_READ_BL_PARTIAL, CSD_WRITE_BLK_MISALIGN, CSD_READ_BLK_MISALIGN, 
               CSD_DSR_IMPL, 
               // different in SD 2.0
//               6'h0,
//               CSD_C_SIZE, 
//               1'b0, 
               //
               2'b00,   // reserved
               12'h001, // C_SIZE = 1, 1*256 * 512 = 128MB C_SIZE * SIZE_MULT * BL_LEN
               3'b000,  // VDD CURR R MIN
               3'b000,  // VDD CURR RMAX
               3'b000,  // VDD CURR W MIN
               3'b000,  // VDD CURR W MAX
               3'b110,  // SIZE mult 6 = 256
               
               CSD_ERASE_BLK_EN, 
               CSD_SECTOR_SIZE, CSD_WP_GRP_SIZE, CSD_WP_GRP_ENABLE,
               2'b00, CSD_R2W_FACTOR, 
               CSD_WRITE_BL_LEN, CSD_WRITE_BL_PARTIAL, 5'h0, CSD_FILE_FORMAT_GRP,
