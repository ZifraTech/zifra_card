...
set rc [catch {
  ...
  add_files -quiet /home/torbjorn/development/vhdl/finalRepo/src/chacha_test2/chacha_test2.runs/synth_1/design_1_wrapper.dcp
  ...
  set_param project.isImplRun true
  link_design -top design_1_wrapper -part xc7a100tcsg324-2
  set_param project.isImplRun false
